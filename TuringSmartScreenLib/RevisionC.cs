        ...
        switch (option)
        {
            case RotateOption.Rotate90:
                for (var y = 0; y < Height; y++)
                {
                    for (var x = 0; x < Width; x++)
                    {
                        Write(bitmap.AsSpan((((Width - 1 - x) * Height) + y) * 3, 3));
                        Write(0xff);
                    }
                }
                break;
            case RotateOption.Rotate270:
                for (var y = 0; y < Height; y++)
                {
                    for (var x = 0; x < Width; x++)
                    {
                        Write(bitmap.AsSpan(((x * Height) + (Height - 1 - y)) * 3, 3));
                        Write(0xff);
                    }
                }
                break;
            case RotateOption.Rotate180:
                for (var y = 0; y < Height; y++)
                {
                    for (var x = 0; x < Width; x++)
                    {
                        Write(bitmap.AsSpan((((Height - 1 - y) * Width) + (Width - 1 - x)) * 3, 3));
                        Write(0xff);
                    }
                }
                break;
            default:
                for (var y = 0; y < Height; y++)
                {
                    for (var x = 0; x < Width; x++)
                    {
                        Write(bitmap.AsSpan(((y * Width) + x) * 3, 3));
                        Write(0xff);
                    }
                }
                break;
